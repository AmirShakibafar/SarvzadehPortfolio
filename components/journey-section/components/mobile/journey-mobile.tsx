        ...
        return (
          <div key={index} className="relative flex flex-col w-full isolate">
            ...
            <ScrollTrigger className="flex flex-col gap-6 px-4 pt-12 pb-20 relative z-10 scroll-stagger-group">
              {/* Illustration at 100ms */}
              <div
                className={`w-[80%] max-w-[280px] stagger-scale-item ${isEven ? "self-start" : "self-end"}`}
              ...
              <div
                className={`w-[90%] flex flex-col gap-4 mt-2 ${isEven ? "self-end" : "self-start"}`}
              >
                {/* Texts perfectly staggered behind the image */}
                <span
                ...
                <h3
                  className="text-balance text-2xl font-bold leading-snug text-foreground stagger-item"
                  style={{ animationDelay: "300ms" }}
                >
                  {step.title}
                </h3>
                <p
                  className="text-base leading-relaxed text-muted-foreground stagger-item"
                  style={{ animationDelay: "400ms" }}
                >
                  {step.text}
                </p>
                <div
                  className="mt-1 flex flex-wrap gap-2 stagger-item"
                ...
                <div
                  className="relative isolate mt-4 stagger-item"
